      ...
      <div className="members-con">
        <div className="member-card">
          ...
          <p><em>
            ...
            brings her closer to achieving her goals"</em>
          </p>
          <p>Position: Leader <br></br>
        ...
        <div className="member-card">
          ...
          <p><em>"A determined IT student preparing to be part of the digital future."</em>
          </p>
           <p>Position: Member<br></br>
              dungorosebren34@gmail.com</p>
        </div>
        ...
        <div className="member-card">
          ...
          <p><em>
            "An IT student who sees technology as a tool to turn small ideas into
            big possibilities"</em>
          </p>
           <p>Position: Member<br></br>
              cruzjazminee50@gmail.com</p>
        </div>
        ...
        <div className="member-card">
          ...
          <p><em>
            ...
            building bridges between people and possibilities"</em>
          </p>
           <p>Position: Member<br></br>
              clasinmaryje56@gmail.com</p>
        </div>
        ...
        <div className="member-card">
          ...
          <p><em>
            ...
            ideas into creative, functional solutions that bridge design and
            technology."</em>
          </p>
           <p>Position: Member<br></br>
              velasquezmichaeljabez24@gmail.com</p>
        </div>
        ...
        <div className="member-card">
          ...
          <p><em>
            "As an IT student, I'm defining my future with every line of code I
            write."</em>
          </p>
           <p>Position: Member<br></br>
              cabalejojehus55@gmail.com</p>
        </div>
        ...
        <div className="member-card">
          ...
          <p><em>
           ...
           <p>Position: Member<br></br>
              cenidojesus2203308@gmail.com</p>
        </div>
      </div>
    </div>
  );
